 ...
 */
/*
 * Calculator v6.0.6 —— GTK4 图形界面（跨平台，可交叉编译）
...
static const Theme THEMES[] = {
    ...
    { "蒙德 风", "#5795a8", "#cde6ec", "#eef6f8", "#1f3b40", "#2b8397", "#8ab9c9",
    ...
    /* 璃月 · 岩（金） */
    { "璃月 岩", "#c9a96a", "#efe0c0", "#fbf5e8", "#3a2c14", "#b8860b", "#d8bd8a",
    ...
    /* 稻妻 · 雷（紫） */
    { "稻妻 雷", "#6a5a9e", "#c3b3ea", "#f4f0fb", "#241a3d", "#7c3aed", "#b9a6e8",
    ...
    /* 须弥 · 草（绿） */
    { "须弥 草", "#4a9e6b", "#c2e6cf", "#eefaf2", "#123726", "#1f9d55", "#9fd4b4",
    ...
    /* 枫丹 · 水（蓝） */
    { "枫丹 水", "#4a90c9", "#bcd8ec", "#eaf4fb", "#12283c", "#1e90d6", "#a8cbe6",
    ...
    /* 纳塔 · 火（橙红，v6.0 新增） */
    { "纳塔 火", "#c65b3a", "#f3d0a8", "#fdf3e4", "#3a1d10", "#d9541e", "#f0b48a",
    ...
    /* 至冬 · 冰（冰蓝白，v6.0 新增） */
    { "至冬 冰", "#5b7ba3", "#dbe7f5", "#f2f7fc", "#14273c", "#2f7fb8", "#b3cee6",
